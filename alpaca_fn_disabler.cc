...
//first log is the memory address
//second log is the value at the mem address (both uint64_t)
void read_writes() {
...
//first log is number of writes and syscalls
//second log is write/syscall flag
//third log is the return_struct
void read_returns() {
...
/*------The following are additional functions used only in the check mode------*/
